...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .requestMatchers("/view/estate").permitAll()
                .requestMatchers("/view/estate/new").permitAll()
                .requestMatchers("/view/estateIndex").permitAll()
                .requestMatchers("/view/work/new").permitAll()
                .requestMatchers("/view/workIndex").permitAll()
                .and()
                .httpBasic()
                .and()
